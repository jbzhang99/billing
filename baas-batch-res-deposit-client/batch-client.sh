...
DEDUCT_HOME=$HOME/applications/opt-baas-services/batch-client    #定义程序的根目录
export DEDUCT_HOME
...
#启动java虚拟机和程序
${JAVA_HOME}/bin/java ${MEM_ARGS}   ${JAVA_OPTIONS} com.ai.runner.center.bmc.core.ResAccount  > $HOME/logs/batch-client.log  2>&1 &
