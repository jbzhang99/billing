...
DEDUCT_HOME=$HOME/applications/opt-baas-services/baas-abm-service    #定义程序的根目录
export DEDUCT_HOME
...
#启动java虚拟机和程序
${JAVA_HOME}/bin/java ${MEM_ARGS}   ${JAVA_OPTIONS} com.ai.baas.abm.api.account.impl.AccountRecordSVImpl  > $HOME/logs/baas-abm-clear-account.log  2>&1 &
