...
import com.ai.baas.ccp.topoligy.core.manager.service.db.ScoutStatusServiceImpl;
...
public class ScoutActBms {
	...
	void setdefault(OmcObj owner, ConfigContainer cfg, RealTimeBalance balance, JsonObject data){
	    this.config = cfg;
        this.omcobj = owner;
        this.indata = data;
