...
import com.ai.baas.ccp.topoligy.core.constant.ServiceStatus;
import com.ai.baas.ccp.topoligy.core.constant.StatusChgType;
import com.ai.baas.ccp.topoligy.core.constant.SubsStatus;
import com.ai.baas.ccp.topoligy.core.constant.rule.MatchUser;
...
public final class ActionRule {
    ...
    public static boolean canAction(String action, User user,
            ConfigContainerObject configContainerObject) {
        // TODO:资料匹配
