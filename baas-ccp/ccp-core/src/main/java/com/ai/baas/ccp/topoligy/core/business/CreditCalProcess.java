...
import com.ai.baas.ccp.topoligy.core.business.base.BaseCalProcess;
...
import com.ai.baas.ccp.topoligy.core.manager.service.db.OmcCreditServiceImpl;
...
public final class CreditCalProcess extends BaseCalProcess {
	...
	public void process(ConfigContainer configContainer, InformationProcessor info, JsonObject data) throws OmcException {
	    setdefault(configContainer, info, data);
