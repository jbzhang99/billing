...
import com.ai.baas.ccp.topoligy.core.business.command.rule.ResourceCheck;
...
public final class InformationProcessor extends BaseProcess {
    ...
    public void process(ConfigContainer configContainer, OmcObj omcObj, JsonObject jsonObject)
            throws OmcException {
        setDefault(configContainer, omcObj, jsonObject);
