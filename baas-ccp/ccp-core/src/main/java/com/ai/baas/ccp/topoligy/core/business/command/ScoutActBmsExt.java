...
import com.ai.baas.ccp.topoligy.core.business.command.rule.ActionRule;
...
public class ScoutActBmsExt extends ScoutActBms {
    public ScoutActBmsExt() {
    }

    public ScoutActBmsExt(OmcObj owner, ConfigContainer cfg, RealTimeBalance balance,
            JsonObject data) {
        super(owner, cfg, balance, data);
    }

    public int stop(User user, OmcObj owner, ConfigContainer cfg, RealTimeBalance balance,
            JsonObject data) throws OmcException {
        setdefault(owner, cfg, balance, data);
    ...
    public int start(User user,OmcObj owner, ConfigContainer cfg, RealTimeBalance balance,
            JsonObject data) throws OmcException {
        setdefault(owner, cfg, balance, data);
 ...
 */
    ...
    private Integer getDelaytimes(String delaytype) throws OmcException {
        ...
        // 获取租户允许延迟时间
        String delaystoptimes = cfg.getCfgPara(timestype, this.getOmcobj().getTenantid(), policyId,
                "0");
