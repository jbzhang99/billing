package com.ai.baas.ccp.topoligy.core.business.base;
...
public abstract class BaseCalProcess {
	...
	protected void setdefault(ConfigContainer cfg, InformationProcessor info, JsonObject data) {
	    this.setConfig(cfg);
        this.setInformation(info);
        this.setInput(data);
	}
