...
//        bu.append("       \"mcsPassword\":\"123456\"          ");
        ...
        if (!client.exists(SDKConstants.SDK_MODE_PAAS_DSS_MONGO_MAPPED_PATH)) {
            client.add(SDKConstants.SDK_MODE_PAAS_DSS_MONGO_MAPPED_PATH, bu.toString());
        } else {
            client.modify(SDKConstants.SDK_MODE_PAAS_DSS_MONGO_MAPPED_PATH, bu.toString());
        }
    ...
    public void readMcsConfig() throws ConfigException {
        ...
        String redisconf = client.get(SDKConstants.SDK_MODE_PAAS_DSS_MONGO_MAPPED_PATH);
