...
public final class BmcConstants {
    ...
    public static final class ZxServiceId {
        ...
        public static final String YONYOUHR = "20e7fd16-e5b0-46ec-bc8a-5a4a8232b313";
        public static final String YONYOUYC = "a732806f-46c5-4386-9877-41c5687a5fbc";
    ...
    public static final class CpPricemakingFactor {
        ...
        public static final class FactorName {
            ...
            public static final String EXTDOMAINPACKAGE = "ExtDomainPackage";

            public static final String EXTBANDWIDTH = "ExtBandwidth";
        ...
        public static final class PriceProductType {
            ...
            public static final String SLB_INSTANCE = "slb-instance";

            public static final String SLB_BANDWITH = "slb-bandwith";

            public static final String EIP_INSTANCE = "eip-instance";

            public static final String EIP_BANDWITH = "eip-bandwith";
        }
