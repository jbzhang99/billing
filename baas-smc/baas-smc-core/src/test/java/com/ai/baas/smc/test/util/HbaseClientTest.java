...
public class HbaseClientTest {
    ...
    public void creatTable() throws IOException {
        ...
        HbaseClient.getInstance().creatTable(tableName, new String[] { "test_column" });
        boolean tableExists = HbaseClient.getInstance().getConnection().getAdmin()
    ...
    public void deleteTable() throws IOException {
        String tableName = "hbase_test_table";
        HbaseClient.getInstance().deleteTable(tableName);
        boolean tableExists = HbaseClient.getInstance().getConnection().getAdmin()
                .tableExists(TableName.valueOf(tableName));
