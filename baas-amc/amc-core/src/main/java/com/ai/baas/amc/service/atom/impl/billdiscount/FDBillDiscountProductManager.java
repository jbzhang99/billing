 ...
 * @author fanpw
 */
@Component(value = "FDBillDiscountProductManager")
public class FDBillDiscountProductManager extends AbstractBillDiscountProductManager {
    
    private static final Logger LOG = LogManager.getLogger(FDBillDiscountProductManager.class);

    @Override
    public void validateBillDiscountProductVo(BillDiscountProductVo vo) throws BusinessException {
        if(vo.getTopAmount() <= 0) {
            throw new BusinessException(ExceptCodeConstants.PARAM_IS_NULL, "封顶价必须大于零");
        }
    ...
    public void saveBillDiscountProductDetail(String productId, BillDiscountProductVo vo) {
        ...
        detailInfo.setCalcType(AmcConstants.AmcProductInfo.CalcType.CALC_TYPE_FD);
    ...
    public Map<String, String> assembleExtendInfo(String productId, BillDiscountProductVo vo) {
        ...
        extendInfoMap.put(AmcConstants.AmcProductInfo.AttrName.FD_AMOUNT, String.valueOf(vo.getTopAmount()));
    ...
    public void validateBillDiscountProductUpdateVo(BillDiscountProductUpdateVo vo)
        ...
        if(vo.getTopAmount() != null && vo.getTopAmount().doubleValue() <= 0) {
            throw new BusinessException(ExceptCodeConstants.PARAM_IS_NULL, "封顶价必须大于零");
        }
    }
