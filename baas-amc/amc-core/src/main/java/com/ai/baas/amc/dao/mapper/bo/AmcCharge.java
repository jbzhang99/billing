...
public class AmcCharge {
	...
	public String toString() {
		return "AmcCharge [chargeSeq=" + chargeSeq + ", acctId=" + acctId
				+ ", subsId=" + subsId + ", serviceId=" + serviceId
				+ ", subjectId=" + subjectId + ", totalAmount=" + totalAmount
				+ ", adjustAfterwards=" + adjustAfterwards
				+ ", discTotalAmount=" + discTotalAmount + ", balance="
				+ balance + ", payStatus=" + payStatus + ", lastPayDate="
				+ lastPayDate + ", custId=" + custId + ", custType=" + custType
				+ ", tenantId=" + tenantId + ", billMonth=" + billMonth + "]";
	}
