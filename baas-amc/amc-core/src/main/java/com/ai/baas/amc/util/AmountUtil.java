...
public final class AmountUtil {
    ...
    public static double changeLiToYuan(long liAmount) {
        ...
        return amountDecimal.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
    /**
     * 厘转为分
     * @param liAmount
    ...
    public static long changeLiToFen(long liAmount) {
        BigDecimal amountDecimal = new BigDecimal(Long.toString(liAmount)).divide(BigDecimal.TEN);
