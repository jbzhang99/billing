...
public class AmcChargeCriteria extends AbstractCriteriaSup {
    ...
    protected List<String> billMonths;

    protected Integer limitStart;

    protected Integer limitEnd;

    public AmcChargeCriteria() {
	...
	public void setBillMonths(List<String> billMonths) {
