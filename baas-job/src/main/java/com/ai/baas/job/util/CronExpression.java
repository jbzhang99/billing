...
public final class CronExpression implements Serializable, Cloneable {
    ...
    protected static final Map<String, Integer> lastDayMap = new HashMap<String, Integer>(60);
    static {
        monthMap.put("JAN", 0);
        monthMap.put("FEB", 1);
        monthMap.put("MAR", 2);
...
//        lastDayMap.put("1", value)
    ...
    public String getExpressionSummaryDay(){
        if(!lastdayOfMonth){
    ...
    public String getExpressionSummaryMonth(){
        return getExpressionSetSummary(months);
    }
    public String getExpressionSummaryYear(){
        return getExpressionSetSummary(years);
    }
    public String getExpressionSummaryTime(){
        return null;
    }
