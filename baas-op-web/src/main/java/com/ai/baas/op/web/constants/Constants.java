...
public final class Constants {
    ...
    public static final class Register {
        ...
        /** 缓存命名空间 */
        public static final String CACHE_NAMESPACE = "com.ai.baas.op.register.cache";
    ...
    public static final class VerifyPhoneCode{
        private VerifyPhoneCode() {
        }
        /** 验证成功 */
        public static final String VERIFY_SUCCESS_ID = "000000";
        /** 短信验证码错误ID */
        public static final String VERIFY_SSM_ERROR = "000001";
        /** 短信验证码失效ID */
        public static final String VERIFY_SSM_OVERTIME_ERROR = "000002";
        /** 发送短信手机号不一致错误 */
        public static final String VERIFY_SSM_DUMPHONE_ERROR = "000003";
    }
    
    public static final class UploadFile{
    	private UploadFile(){}
    	
    	public static final String SAVE_LOCATION_KEY = "file_save_location";
    }
