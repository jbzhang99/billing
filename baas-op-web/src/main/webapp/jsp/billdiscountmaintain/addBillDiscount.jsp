...
<title>优惠策略管理-<c:choose><c:when test="${flag=='u' }">修改</c:when><c:when test="${flag=='v'}">查看</c:when><c:otherwise>新增</c:otherwise></c:choose>优惠活动</title>
</head>
...
<div class="wrapper">
    ...
    <div class="management-title step1">请选择优惠类型</div>
    <input name="discountId" value="${productId }" style="display:none;">
    ...
    <!--tab标签第1块 begin-->
	<%@ include file="/jsp/billdiscountmaintain/addbilldiscount/addMZ.jsp"%>
    <!--tab标签第1块 end-->
    
    <!--tab标签第2块 begin-->
	<%@ include file="/jsp/billdiscountmaintain/addbilldiscount/addMJ.jsp"%>
    <!--tab标签第2块 end-->
    
    <!--tab标签第3块 begin-->
	<%@ include file="/jsp/billdiscountmaintain/addbilldiscount/addDZ.jsp"%>
    <!--tab标签第3块 end-->
    
    <!--tab标签第4块 begin-->
	<%@ include file="/jsp/billdiscountmaintain/addbilldiscount/addBD.jsp"%>
    <!--tab标签第4块 end-->
    
    <!--tab标签第5块 begin-->
	<%@ include file="/jsp/billdiscountmaintain/addbilldiscount/addFD.jsp"%>
    <!--tab标签第5块 end-->
...
(function () {
	seajs.use('app/jsp/billdiscountmaintain/addBillDiscount', function (AddBillDiscountPager) {
