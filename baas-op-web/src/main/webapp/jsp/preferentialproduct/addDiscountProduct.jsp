...
<div class="wrapper">
    ...
    <div class="management-title step1">请选择明细级优惠类型</div>
    <div class="Discount">
    <div class="Discount-ttf">
     <ul class="Discounta current">
      <p>满赠优惠</p>
    ...
    <!--tab标签第1块-->
    <div class="Discount-cnt1">
    <div class="management-title step2">请配置满赠明细级优惠</div>
    <div class="configure">
     <div class="tab-form">
      <ul>
       <li>
        ...
        <p>
        <input type="text" class="int-xlarge" id="activityName" maxlength="32">
       ...
       <li>
        ...
        <p><input type="text" id="pOnTime" class="int-medium" readonly><span id="mz_effectDate" class="icon-calendar"></span>
        ...
        <p><input type="text" id="pOffTime" class="int-medium" readonly><span id="mz_expireDate" class="icon-calendar" style="position:relative;left:-35px;"></span>
 ...
 <!-- =======================下边是满减================================= -->
    ...
    <!--tab标签第2块-->
    <div class="Discount-cnt2" style="display:none">
     ...
     <div class="tab-form">
      <ul>
       ...
       <li>
        ...
        <p><input type="text" class="int-medium mana" id="rruleAmount">
        <span class="man">满</span>
        <select id="mj_unit" class="select-small"><option value="">请选择单位</option></select>
        <span class="jian">减</span><input type="text" id="mj_reduceAmount" class="int-medium">元
...
(function () {
	seajs.use('app/jsp/preferentialproduct/addDiscountProduct', function (AddDiscProductPager) {
		var pager = new AddDiscProductPager({element: document.body});
		pager.render();
	});
})();
</script>
