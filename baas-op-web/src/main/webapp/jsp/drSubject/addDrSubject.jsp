...
<title><c:choose><c:when test="${subjectInfo!=null}">编辑</c:when><c:otherwise>新增</c:otherwise></c:choose>详单科目</title>
</head>
...
<div class="wrapper">
	...
	<div class="nav-tplist-title peiz-title">
		...
		<div class="management-cnt" id=""><!--资费管理内容-->
			<form id="discount-step2" >
			<!--查询区域-->
			<div class="nav-form">
				<ul>
					<li>
		                 <p class="word"><span class="f00">*</span>详单科目名称</p>
...
(function () {
	seajs.use('app/jsp/drSubject/addDrSubject', function (AddDrSubjectPager) {
		var pager = new AddDrSubjectPager({element: document.body});
		pager.render();
	});
})();
</script>
