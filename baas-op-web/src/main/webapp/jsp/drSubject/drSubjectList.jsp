          ...
          <div class="nav-form">
                ...
                <div class="nav-tplist"><!--查询结果-->
                	<div class="nav-tplist-title"><!--查询结果标题-->
                		<div class="title-left"><i class="icon-th-list"></i>详单科目管理</div>
                		<div class="title-right">
                			<p class="plus"><a href="#"><i class="icon-plus"></i></a></p>
                			 <p class="plus-word"><a href="${_base}/drSubject/toAdd">添加科目项</a></p>
                		</div>
                	</div>
                	<div class="nav-tplist-table"><!--查询结果列表-->
                		 <table width="100%" border="0">
                		 	<tr class="tr-backgrond">
                		 		<td class="left-border">详单科目ID</td>                                                                                                                                 
							    <td>详单科目名称</td>
							    <td>详单科目描述</td>
				  ...
				  <script id="billSubjectDataTmpl" type="text/x-jsrender">
                	...
                	<div id ="pagination-ul" style="text-align: right">
					  </div>
                </div>
          </div>
		</div>
...
var pager;
(function () {
	seajs.use('app/jsp/drSubject/drSubjectList', function (DrSubjectPager) {
		pager = new DrSubjectPager({element: document.body});
		pager.render();
	});
})();
</script>
