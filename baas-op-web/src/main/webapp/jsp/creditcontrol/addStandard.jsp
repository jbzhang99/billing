...
<div class="wrapper">
   <div class="management"><!--资费管理外侧-->
      <div class="nav-tplist-title peiz-title">
            <div class="title-left">新建信控规则</div>
            </div>
   <div class="management-cnt">
    <div class="nav-form">
                 ...
                 <p>
                 	<input id="ruleName" type="text" class="int-medium" >
                 ...
                 <p>
                 	<input id="pressPayment" type="text" class="int-medium" >
                 ...
                 <p>
                 	<textarea id="description" class="textarea-xxlarge"></textarea>
           ...
           <ul>
           	<li>
           		<input id="addBtn" type="button" class="bass-btn peiz-btn" value="保  存">
...
(function () {
	seajs.use('app/jsp/creditcontrol/addStandard', function (AddStandardPager) {
		var pager = new AddStandardPager({element: document.body});
		pager.render();
	});
})();
</script>
