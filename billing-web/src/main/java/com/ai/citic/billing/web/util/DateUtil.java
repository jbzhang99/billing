...
public final class DateUtil {
     ...
     */
    public static List<String> getMonthListBetweenTimes(String start, String end, 
    		String enterPattern, String returnPattern) throws ParseException{
    	if(org.apache.commons.lang3.StringUtils.isNoneBlank(start, end, enterPattern, returnPattern)){
    		List<String> result = new ArrayList<>();
    		SimpleDateFormat sdf= new SimpleDateFormat(enterPattern);
    		SimpleDateFormat formatter = new SimpleDateFormat(returnPattern);
    		...
    		if(!result.contains(formatter.format(endCalendar.getTime()))){
    			result.add(formatter.format(endCalendar.getTime()));
    		}
    		return result;
    	}
