	...
	<div class="zuhu-title">
      ...
      <!--  <li>
        ...
        <li>
       		...
       		<p><button class="btn-query" id="cancelBtn">返回</button></p>
       </li>
      </ul>
     </div>
      ...
      <div class="wdTemp weidus" style="display:none;">
       ...
       <li>
       	<p class="tab-form-name"><i>*</i>定价维度:</p>
        <p><input type="text" class="int-small "  name="dimensionName" tip="维度名称不能为空" readonly></p>
        <p><i>*</i>维度编码</p>
        <p><input type="text" class="int-small "  name="dimensionCode" tip="维度编码不能为空" readonly></p>
        <!-- <p><a href="javascript:void(0);"   class="addBr red">添加分支</a></p> -->
       ...
       <li>
        ...
        <p><input type="text" class="int-small"  name="branchName" tip="分支名称呢不能为空" readonly></p>
        <p><i>*</i>分支编码</p>
        <p><input type="text" class="int-small"   name="branchCode" tip="分支编码不能为空" readonly></p>
...
<script type="text/javascript" charset="utf-8">
        $(function () {
            seajs.use('app/jsp/product/viewProduct', function (ViewProPager) {
                var pager = new ViewProPager({
