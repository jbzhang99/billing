define('app/jsp/bill/billSearch', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var BillSearchPager = Widget.extend({
        //属性，使用时由类的构造函数传入
        attrs: {
        },
        Statics: {
        ...
        //重写父类
        setup: function () {
            BillSearchPager.superclass.setup.call(this);
            this._initSelect();
            this.searchBillList();
        },
        ...
        searchBillList:function(){
            ...
            $("#pagination").runnerPagination({
                url: _base+"/bill/billSearch",
                method: "POST",
                dataType: "json",
                processing: true,
                data : data,
                pageSize: BillSearchPager.DEFAULT_PAGE_SIZE,
                visiblePages:5,
                message: "正在为您查询数据..",
    ...
    module.exports = BillSearchPager;
});
