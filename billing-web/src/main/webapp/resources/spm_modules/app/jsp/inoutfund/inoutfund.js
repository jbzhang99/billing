define('app/jsp/inoutfund/inoutfund', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var InoutfundPager = Widget.extend({
        //属性，使用时由类的构造函数传入
        attrs: {
        },
        Statics: {
        ...
        //重写父类
        setup: function () {
        	InoutfundPager.superclass.setup.call(this);
            this._initSelect();
            this._bindCalendar();
            this._bindByMonth();
            this._init();
...
//			endCalendar.range(['2016-02-01',this._getEndDate()]);
        ...
        queryFundList:function(){
            ...
            $("#pagination-ul").runnerPagination({
                url: _base+"/inOutFund/queryInOutFundList",
                method: "POST",
                dataType: "json",
                processing: true,
                data : data,
                pageSize: InoutfundPager.DEFAULT_PAGE_SIZE,
                visiblePages:5,
                message: "正在为您查询数据..",
