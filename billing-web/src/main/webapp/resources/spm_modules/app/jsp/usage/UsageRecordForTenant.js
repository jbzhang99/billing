define('app/jsp/usage/UsageRecordForTenant', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var UsageRecordForTenantPager = Widget.extend({
        //属性，使用时由类的构造函数传入
        ...
        //重写父类
        setup: function () {
            UsageRecordForTenantPager.superclass.setup.call(this);
            this._initSelect();
            this._bindCalendar();
        },
        _exportUsageRecords:function(){
            ...
            ajaxController.ajax({
                type: "post",
                dataType : "json",
                url: _base+"/usage/searchRecordsForTenant",
                processing: true,
                message: "正在加载，请等待...",
                data:data,
    ...
    module.exports = UsageRecordForTenantPager;
});
