define('app/jsp/policy/policyUpdate', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var PolicyUpdatePager = Widget.extend({
        //属性，使用时由类的构造函数传入
        attrs: {
        },
        Statics: {
        ...
        //重写父类
        setup: function () {
            PolicyUpdatePager.superclass.setup.call(this);
            this._initPage();
        },
        _initPage:function () {
        	var _this = this;
    ...
    module.exports = PolicyUpdatePager;
});
