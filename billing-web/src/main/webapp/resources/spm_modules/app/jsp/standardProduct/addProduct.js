define('app/jsp/standardProduct/addProduct', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var AddProductPager = Widget.extend({
        //属性，使用时由类的构造函数传入
        attrs: {
        },
        Statics: {
        ...
        //重写父类
        setup: function () {
            AddProductPager.superclass.setup.call(this);
            this._initSelect();
        },
        cancel:function () {
        ...
        selectStrategy:function () {
            ...
            $("#pagination-ul").runnerPagination({
                ...
                pageSize: AddProductPager.DEFAULT_PAGE_SIZE,
                visiblePages:5,
                message: "正在为您查询数据..",
        ...
        saveStandardProduct:function(){
            ...
            if(_this.verify()){
                ...
                ajaxController.ajax({
                    type: "post",
                    dataType : "json",
                    url: _base+"/standardProduct/saveStandardProduct",
                    processing: true,
                    message: "正在保存，请等待...",
                    data:data,
                    success: function(data){
    ...
    module.exports = AddProductPager;
});
