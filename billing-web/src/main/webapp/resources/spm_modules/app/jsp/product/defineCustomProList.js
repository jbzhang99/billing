define('app/jsp/product/defineCustomProList', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
...
//            "change #tradeType":"_changeSelect",
			...
			$.ajax({
				...
				success : function(data) {
					...
					$.each(d, function(index, item) {
						...
						$("#tradeType").append('<option '+ selectedStr +'value="' + paramCode+'|'+paramId
										+ '">' + paramName
										+ '</option>');
					})
        ...
        _initMainProduct:function(){
        	$("#mainPro").html("");
        	$("#mainPro").append('<option value="' + $('#mainProductId').val()+'|000'
					+ '">' + $('#mainProductName').val()
					+ '</option>');
        },
