define('app/jsp/product/editCustomProduct', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    var wd=1;
    //定义页面组件类
    var EditProPager = Widget.extend({
        //属性，使用时由类的构造函数传入
        attrs: {
        },
        Statics: {
        ...
        //重写父类
        setup: function () {
        	EditProPager.superclass.setup.call(this);
