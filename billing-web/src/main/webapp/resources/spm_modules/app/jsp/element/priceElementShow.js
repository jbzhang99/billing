define('app/jsp/element/priceElementShow', function (require, exports, module) {
    'use strict';
    var $=require('jquery'),
    ...
    //定义页面组件类
    var PriceElementShowPager = Widget.extend({
        //属性，使用时由类的构造函数传入
        attrs: {
        ...
        //重写父类
        setup: function () {
        	PriceElementShowPager.superclass.setup.call(this);
        	this._initFunction();
        },
        ...
        _bindPolicySelect:function(){
    		...
    		$(".policy-select").bind("click",function(){
    			...
    			$("#pagination-ul").runnerPagination({
                    ...
                    pageSize: PriceElementShowPager.DEFAULT_PAGE_SIZE,
                    visiblePages:5,
                    message: "正在为您查询数据..",
        ...
        _saveElement:function(){
        	...
        	$("#elementList").find(".elementTemp").each(function(){
        		...
        		var element = {
        				...
        				specTypeId : $(this).find("select").find("option:selected").attr("unid"),
        	...
        	ajaxController.ajax({
	             ...
	             data : {
	            	 ...
	            	 "mainProductId" : $("#mainPro").find("option:selected").attr("unid"),
    ...
    module.exports = PriceElementShowPager;
});
