...
(function () {
	seajs.use([
		       ...
		       "projectcss/font-awesome.css",
		       "projectcss/frame.css",
		       "projectcss/global.css",
		       "projectcss/modular.css"
	]);
...
5 下拉框 <a href="#" id="example2" class="ui-select-trigger">请选择</a> <br/><br/>
...
<div id="listview">数据</div>
<div id="pageview">分页</div>
<style>
.ui-table {
    margin-bottom: 1em;
}
