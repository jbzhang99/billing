...
/**
 * 功能：签名工具类 说明： 该代码是示例代码，供研究和开发联通支付接口使用，商户可以按接口自己编写。 建议不做修改。
 * 
 * 作者 联通支付平台接口开发团队 版本：1.0 日期：2011-10-25
 * 
 */
public class UniPaySignUtils {

    private static final Logger LOGGER = LoggerFactory.getLogger(UniPaySignUtils.class);
    ...
    public static String getMd5SignMsg(Map<String, String> params, String key, String inputCharset) {
        ...
        String signMsg = Encrypt.crypToDes(signSource, key);
