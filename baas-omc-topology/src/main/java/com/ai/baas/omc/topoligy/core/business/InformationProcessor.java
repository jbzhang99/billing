...
public final class InformationProcessor extends BaseProcess {
    ...
    public InformationProcessor(ConfigContainer cfg, OmcObj obj, JsonObject data)
            throws OmcException {
        super(cfg, obj, data);
    ...
    public void process() throws OmcException {
        ...
        String infofrom = cfg.getCfgPara(OmcCalKey.OMC_CFG_INFORMATION_FROM, tenantid, policyId,
                null);
        // 初始bean，确定三户信息的来源
