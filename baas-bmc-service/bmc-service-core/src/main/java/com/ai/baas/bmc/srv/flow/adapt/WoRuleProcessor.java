...
public class WoRuleProcessor implements IRuleProcessor {
	private static Logger logger = LoggerFactory.getLogger(WoRuleProcessor.class);
	private BasicInfo basicInfo = new BasicInfo();
	
	@Override
	public void buildRuleAdapt(Map<String, String> data)
