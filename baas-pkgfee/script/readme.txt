...
docker run -it --net=host -e "REST_REGISTRY_ADDR=10.1.130.84:39181" -e "REST_PORT=10774" -e "PROTOCOL=rest" -e "SDK_MODE=1" -e "CCS_NAME=aiopt-baas-bmc" -e "ZK_ADDRESS=10.1.130.84:39181" baas-bmc