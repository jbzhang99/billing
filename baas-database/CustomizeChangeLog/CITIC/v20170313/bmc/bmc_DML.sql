...
VALUES ('ECITIC', 'DISK', 'ALIDISK', '1', '0', '业务标识', 'service_id', 'STRING', '业务标识', NULL, NULL);
INSERT INTO `bmc_record_fmt` (`tenant_id`, `service_type`, `source`, `format_type`, `field_serial`, `field_name`, `field_code`, `data_type`, `comments`, `nullable`, `is_sn`)
 VALUES ('ECITIC', 'DISK', 'ALIDISK', '1', '1', '服务实例', 'instance_id', 'STRING', '服务实例', NULL, NULL);
INSERT INTO `bmc_record_fmt` (`tenant_id`, `service_type`, `source`, `format_type`, `field_serial`, `field_name`, `field_code`, `data_type`, `comments`, `nullable`, `is_sn`)
 VALUES ('ECITIC', 'DISK', 'ALIDISK', '1', '2', '区域', 'region_id', 'STRING', '区域', NULL, NULL);
INSERT INTO `bmc_record_fmt` (`tenant_id`, `service_type`, `source`, `format_type`, `field_serial`, `field_name`, `field_code`, `data_type`, `comments`, `nullable`, `is_sn`)
 VALUES ('ECITIC', 'DISK', 'ALIDISK', '1', '3', '使用量', 'usage_amount', 'STRING', '使用量', NULL, NULL);
INSERT INTO `bmc_record_fmt` (`tenant_id`, `service_type`, `source`, `format_type`, `field_serial`, `field_name`, `field_code`, `data_type`, `comments`, `nullable`, `is_sn`) 
VALUES ('ECITIC', 'DISK', 'ALIDISK', '1', '4', '开始时间', 'start_time', 'STRING', '开始时间', NULL, NULL);
INSERT INTO `bmc_record_fmt` (`tenant_id`, `service_type`, `source`, `format_type`, `field_serial`, `field_name`, `field_code`, `data_type`, `comments`, `nullable`, `is_sn`)
 VALUES ('ECITIC', 'DISK', 'ALIDISK', '1', '5', '报文类型', 'record_type', 'STRING', '报文类型', NULL, NULL); 
