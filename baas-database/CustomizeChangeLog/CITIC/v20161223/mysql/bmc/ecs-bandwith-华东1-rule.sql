...
values
('ECITIC', 'ECS-BANDWITH', '10204', 'PER_UNIT1G', 'EXPR', '#{dis}*(720)', '{"dis":"0.7"}', 'gb', '/GB'),
('ECITIC', 'ECS-BANDWITH', '20204', 'PER_HOUR', 'STEP', '[{"start":"1", "end":"5", "value":"43.75"}, {"start":"6", "end":"9999999999", "value":"175"}]', 'InternetMaxBandwidthOut', 'h', '/时');
