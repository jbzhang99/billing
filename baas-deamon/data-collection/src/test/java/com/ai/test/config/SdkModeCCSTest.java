...
public class SdkModeCCSTest {
    ...
    public void addMdsConfig() throws ConfigException {
        ...
        // 空间（这个是命名空间，在嗲用客户端的时候使用，多余的可以删除掉 ，只写自己命名空间的就行）
        String mdssnsConfig = "{\"ns-baas-data-collection\":\"" + mds001
                + "\"}";
        ...
        sb_kafkaSend.append("		{                                                                                                     ");
        sb_kafkaSend.append("			\"metadata.broker.list\":\"10.1.235.246:39091\",                                                          ");
        ...
        sb_kafkaSend.append("			\"mds.topic\":\"baas-tr-topic\"                                                                              ");
        sb_kafkaSend.append("		}                                                                                                     ");
        sb_kafkaSend.append("}                                                                                                        ");
        ...
        sb_kafkaConsume.append("		{                                                                                                     ");
        sb_kafkaConsume.append("			\"kafka.zookeeper.hosts\":\"10.1.235.246:29181\",                                                          ");
        ...
        sb_kafkaConsume.append("			\"mds.consumer.base.path\":\"/baas/datacollect/MDS/MDS001\",                                                                            ");
        sb_kafkaConsume.append("			\"mds.zookeeper.hosts\":\"10.1.235.246:29181\",                                                                            ");
        sb_kafkaConsume.append("			\"mds.topic\":\"baas-tr-topic\"                                                                              ");
        sb_kafkaConsume.append("		}                                                                                                     ");
        sb_kafkaConsume.append("}                                                                                                        ");
