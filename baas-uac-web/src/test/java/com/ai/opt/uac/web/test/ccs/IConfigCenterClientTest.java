...
public class IConfigCenterClientTest {
    ...
    public void addMcsConfig() throws ConfigException {
     ...
     public void addUrlConfig() throws ConfigException{
    	 ...
    	 String citic_indexUrl = "http://10.1.235.245:14125/citic-uac";
    	 if (!client.exists(Constants.URLConstant.CITIC_INDEX_URL_KEY)) {
             client.add(Constants.URLConstant.CITIC_INDEX_URL_KEY, citic_indexUrl);
         } else {
             client.modify(Constants.URLConstant.CITIC_INDEX_URL_KEY, citic_indexUrl);
         }
    	 
    	 
    	 String citic_yun_mall_indexUrl = "http://10.1.235.245:14125/citic-uac";
    	 if (!client.exists(Constants.URLConstant.CITIC_YUN_MALL_INDEX_URL_KEY)) {
    		 client.add(Constants.URLConstant.CITIC_YUN_MALL_INDEX_URL_KEY, citic_yun_mall_indexUrl);
    	 } else {
    		 client.modify(Constants.URLConstant.CITIC_YUN_MALL_INDEX_URL_KEY, citic_yun_mall_indexUrl);
    	 }
    	 
    	 String citic_help_indexUrl = "http://10.1.235.245:14125/citic-uac";
    	 if (!client.exists(Constants.URLConstant.CITIC_HELP_INDEX_URL_KEY)) {
    		 client.add(Constants.URLConstant.CITIC_HELP_INDEX_URL_KEY, citic_help_indexUrl);
    	 } else {
    		 client.modify(Constants.URLConstant.CITIC_HELP_INDEX_URL_KEY, citic_help_indexUrl);
    	 }
