...
<%
    ...
    String _baasBase=_base+"/theme/citic";
...
<!-- UED style begin -->
 <link href="${_base}/theme/citic/css/login.css" rel="stylesheet" type="text/css">
 <script type="text/javascript" src="${_base}/theme/citic/js/jquery-1.11.1.min.js" ></script>
<!-- UED style end -->
