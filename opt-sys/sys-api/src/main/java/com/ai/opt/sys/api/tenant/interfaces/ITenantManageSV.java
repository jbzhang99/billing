package com.ai.opt.sys.api.tenant.interfaces;
...
public interface ITenantManageSV {
     ...
     * @ApiDocMethod
     * @ApiCode
     * @RestRelativeURL tenantmanage/queryTenantInfos
     */
    @GET
    @Path("/queryTenantInfos")
    TenantInfoResponse queryTenantInfos(TenantInfoVo queryInfo) throws BusinessException,SystemException;
}
