...
import com.ai.baas.dst.constants.DstConstants.DiscountInfo.ConfigSetting;
...
public final class BusinessUtil {
	...
	public static String getDecimalModeByConfig(){
		String decimalMode = DecimalMode.UP;
		try{
			String data = CCSClientFactory.getDefaultConfigClient().get(ConfigSetting.CONFIG_PATH);
			if(StringUtil.isBlank(data)){
				Map<String, String> map = (Map<String, String>) com.alibaba.fastjson.JSONObject.parse(data);
				decimalMode = map.get("DecimalMode");
			}
		} catch (ConfigException e) {
			// TODO Auto-generated catch block
			LOGGER.error("未查询到配置信息", e);
		}
		return decimalMode;
	}
