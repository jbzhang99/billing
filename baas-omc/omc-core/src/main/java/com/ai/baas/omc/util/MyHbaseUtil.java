...
//	public static Logger log = Logger.getLogger(MyHbaseUtil.class);
//
...
//		return Bytes.toString(CellUtil.cloneValue(r.getColumnLatestCell(Bytes.toBytes(family), Bytes.toBytes(qualifier))));
//	}
//
//	/**
//	 * 写入hbase
...
//		}
//
//		public static CellTemp inst(String colum, String data) throws UnsupportedEncodingException {
